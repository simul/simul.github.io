...
We specify the depth texture style so that trueSKY knows how to interpret the depth information you pass to it. The matrices [simul::math::matrix4x4](/ref/simul/math/matrix4x4)
...
Once per frame, before rendering , we must call PreRenderUpdate, located in [cloud](/ref/cloud)
, passing a deviceContext that refers to mainview.
~~~~~~~~~~~~~~~{.cpp}
