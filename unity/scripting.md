...
For information about the layer properties you can change and the name strings needed to do so, see the [Cloud](/tutorials/clouds) and [Sky](/tutorials/sky.html) pages.
